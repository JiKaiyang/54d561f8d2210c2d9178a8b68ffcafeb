...
EAPI=4
inherit autotools gnome2-utils multilib eutils

DESCRIPTION="Canonical's on-screen-display notification agent"
HOMEPAGE="http://launchpad.net/notify-osd"
SRC_URI="https://launchpad.net/~leolik/+archive/leolik/+files/notify-osd_0.9.35%2B14.04.20140213-0ubuntu1-leolik%7Eppa1.tar.gz"
...
S="${WORKDIR}/notify-osd-0.9.35+14.04.20140213"
