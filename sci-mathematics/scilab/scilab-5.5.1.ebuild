...
src_prepare() {
	epatch \
		"${FILESDIR}/${P/1/0}-followlinks.patch" \
		"${FILESDIR}/${P/1/0}-gluegen.patch" \
		"${FILESDIR}/${P/1/0}-fix-random-runtime-failure.patch" \
		"${FILESDIR}/${P/1/0}-accessviolation.patch" \
		"${FILESDIR}/${P/1/0}-nogui.patch"
